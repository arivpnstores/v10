...
TIMES="10"
eval $(wget -qO- "https://raw.githubusercontent.com/arivpnstores/v10/main/Fls/botkey")
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m           WELCOME TO SRICPT ARISCTUNNEL V10           \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/arivpnstores/v10/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/arivpnstores/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/arivpnstores/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/arivpnstores/v10/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/arivpnstores/v10/main/Cfg/m-noobz 
